...
activity21 = { name: "We are going to dance ! Salsa, Kizomba", category: "Dancing", place: "Edifício 78, Santos, Rua da Cintura do Porto de Lisboa Armazem, Lisbon", description: "For lovers of Salsa and Kizomba, go for an evening of madness with very very good dancers. Be careful, you need a minimum level in Latin dance to really have fun on the dance floor.", owner_id: User.all.sample(1)[0].id, capacity_max: "20", start_date: DateTime.new(2021,12,5,20), end_date: DateTime.new(2021,12,6,2), photo: "https://images.unsplash.com/photo-1504609813442-a8924e83f76e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8c2Fsc2F8ZW58MHx8MHx8&auto=format&fit=crop&w=800&q=60" }

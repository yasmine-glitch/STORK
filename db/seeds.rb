...
activity1 = { name: "Visiting Sintra", place: "Sintra, Lisbon, Portugal", description: "Let's go on a day trip to Sintra to visit the Palaces. Who wants to join ? :)", owner_id: User.find_by_first_name('Amelie').id, capacity_max: "10", start_date: DateTime.new(2021,9,1,17), end_date: DateTime.new(2021,9,2,17), photo: "https://images.unsplash.com/photo-1562195168-c82fea0f0953?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8c2ludHJhfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60" }

activity2 = { name: "The pastry tour : tasting typical Lisbon egg tarts in Alfama", place: "Alfama, Lisbon, Portugal", description: "If you too love pastries, join me on a tour of all the pastries in Alfama. The goal is to taste the best pasteis de nata to choose our favorite. Ready ?", owner_id: User.find_by_first_name('Amelie').id, capacity_max: "8", start_date: DateTime.new(2021,9,1,17), end_date: DateTime.new(2021,9,2,17), photo: "https://media.istockphoto.com/photos/portugal-egg-tart-with-azulejo-picture-id1124635330?b=1&k=20&m=1124635330&s=170667a&w=0&h=PbHCGQhL-kaB7Q8Ya1TXKrWe6uOLRE5woiAmSUWdbpU=" }

activity3 = { name: "Learning Fado with Lourenço and Carla - singing lesson", place: "Chiado, Lisbon, Portugal", description: "For music and singing lovers, I suggest you join me for a great Fado course for beginners with artists Lourenço and Carla. I met them during my last stay in Lisbon and promised myself to discover Fado with them on my next stay. There are only six spots for this session so don't wait to register!", owner_id: User.find_by_first_name('Jason').id, capacity_max: "6", start_date: DateTime.new(2021,9,1,17), end_date: DateTime.new(2021,9,2,17), photo: "https://media.istockphoto.com/photos/band-performing-traditional-music-fado-under-pergola-with-azulejos-in-picture-id1064650996?b=1&k=20&m=1064650996&s=170667a&w=0&h=GH90-V2xVAO_cTwgFSeZWc_mICTH8WCAT7eivprukKY=" }

activity4 = { name: "Cooking class with Bruna", place: "Belém, Lisbon, Portugal", desription: "An event not to be missed! I suggest you come with me for a cooking class with chef Bruna in the heart of the Bélem district. We will learn to cook nine typical dishes that we will then share during a dinner accompanied by good local wines. The class takes place in Bruna's restaurant. Here is the list of dishes that we will learn to cook: Bacalhau com Natas, Arroz de Marisco, Dourada Grelhada, Bacalhau in Brás, Bife a Café, Carne by Porco Alentejana, Sardinhas Assadas, Arroz de Pato, Arroz de Tamboril.", owner_id: User.find_by_first_name('Karim').id, capacity_max: "4", start_date: DateTime.new(2021,9,1,17), end_date: DateTime.new(2021,9,2,17), photo: "https://images.unsplash.com/photo-1549590143-d5855148a9d5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8Y29va2luZ3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60" }

activity5 = { name: "Networking event for tech people in Bairro Alto", place: "Bairro Alto, Lisbon, Portugal", description: "With my amazing workmates at Softbank,Tokyo, we organize a dev&tech gathering in a bar in Bairro Alto this saturday night. Come join us for a crazy night out !", owner_id: User.find_by_first_name('Caroline').id, capacity_max: "30", start_date: DateTime.new(2021,9,1,17), end_date: DateTime.new(2021,9,2,17), photo: "https://media.istockphoto.com/photos/casual-catering-discussion-meeting-colleagues-concept-picture-id597940046?b=1&k=20&m=597940046&s=170667a&w=0&h=GSqvi2bfqWORR4PUTkzh4j1AcXK3katN4ml5MpkqnWo=" }
...
booking1 = { user_id: User.find_by_first_name('Sam'), activity_id: Activity.find_by_name('Visiting Sintra') }
booking2 = { user_id: User.find_by_first_name('Yukio'), activity_id: Activity.find_by_name('Visiting Sintra') }

...
activity15 = { name: "Breakfast at Pokawa", category: "Food", place: "Rua da Misericórdia 71, Lisbon", description: "Join Karim for a delicious breakfast at Pokawa. Never enough poké 🙈. Miam Délish.", owner_id: User.find_by_first_name('Karim').id, capacity_max: "8", start_date: DateTime.new(2021,11,26,8), end_date: DateTime.new(2021,11,26,9), photo: "https://media.istockphoto.com/photos/dried-codfish-picture-id1130773985?b=1&k=20&m=1130773985&s=170667a&w=0&h=D3tEKGIFvvTLYcQA6Xe8L9efDsJbuYLFc77kQo0HCN4=" }
